...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n    background-color: bisque;\n}", "",{"version":3,"sources":["webpack://./src/options/options.css"],"names":[],"mappings":"AAAA;IACI,wBAAwB;AAC5B","sourcesContent":["body{\n    background-color: bisque;\n}"],"sourceRoot":""}]);
// Exports
...
const test = react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Option Page");
